...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        txtRotaId = new javax.swing.JTextField();
        ...
        jLabel2.setText("RotaId ");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(80, 70, 60, 16);

        jLabel3.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel3.setText("Local de saída:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(80, 110, 110, 12);
        ...
        jLabel5.setBounds(80, 190, 140, 16);

        jLabel6.setFont(new java.awt.Font("Verdana", 1, 12)); // NOI18N
        jLabel6.setText("Gastos Extras:");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(80, 220, 96, 16);

        txtRotaId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtRotaIdActionPerformed(evt);
            }
        });
        txtRotaId.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtRotaIdKeyTyped(evt);
            }
        });
        getContentPane().add(txtRotaId);
        txtRotaId.setBounds(240, 60, 160, 30);
        ...
        txtSaida.setBounds(240, 100, 160, 30);
        ...
        txtDestino.setBounds(240, 140, 160, 30);
        ...
        txtDistanciaPercorrida.setBounds(240, 180, 160, 30);
        ...
        txtGastosExtras.setBounds(240, 220, 160, 30);
        ...
        btnCadastrar.setBounds(260, 260, 100, 30);
        ...
        btnLimpar.setBounds(140, 260, 79, 30);
        ...
        jLabel7.setBounds(0, 0, 520, 440);

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void txtRotaIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRotaIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtRotaIdActionPerformed
    ...
    private void txtRotaIdKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRotaIdKeyTyped
    ...
    }//GEN-LAST:event_txtRotaIdKeyTyped
    ...
    private javax.swing.JTextField txtRotaId;
    ...
    private void carregaRota() {
        ...
        for (int x = 0; x < listaRota.size(); x++) {
            Rota us = listaRota.get(x);
            if (id == us.getRotaId()) {

                txtRotaId.setText(us.getRotaId() + "");
                txtSaida.setText(us.getSaida());
                txtDestino.setText(us.getDestino());
                txtDistanciaPercorrida.setText(us.getDistanciaPercorrida());
                txtGastosExtras.setText(us.getGastosExtras());
                rota = us;
                break;
            }
        }
